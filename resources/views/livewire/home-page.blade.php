<div class="bg-slate-50">
                    ...
                    <div class="hero-content flex-col justify-start lg:flex-row">
                        <div class="">
                            ...
                            <div class="w-1/2">
                                ...
                                <button
                                    class="btn bg-primary-800 hover:bg-primary-600 border-none text-white mr-3">Register
                                    Now</button>
    ...
    <div class="hero lg:hidden sm:inline-block min-h-screen bg-slate-800"
    ...
    <div class="lg:px-14 px-3 flex justify-center">
        <div
            class="card w-full lg:w-1/2 bg-doctor bg-primary-50 text-white -top-20 md:-top-5 lg:-top-52 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105">
    ...
    <div class="pb-24 px-4 mb-5 container mx-auto items-center">
        <div class="flex flex-col gap-5 justify-between lg:flex-row">
            <div class="w-full justify-center flex">
                <img src="images/about_left.png"
                    class="w-fit transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110" />
            </div>
    ...
    <div class="pb-24 px-4 mb-10 container mx-auto items-center mt-10">
        <div class="flex flex-col lg:flex-row justify-between gap-20">
            <div class="lg:w-1/2 w-full">
                ...
                <img class="float-left rounded-lg ring ring-primary ring-offset-base-100 ring-offset-4 w-32 m-3"
